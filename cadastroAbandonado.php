...
<html lang="pt-BR">
    ...
    <body>
        ...
        <form action='cadastroAbandonado.php' method='POST' class="row g-3 needs-validation was-validated" novalidate id="formcadastro" enctype="multipart/form-data">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <label for="validationCustom05" class="form-label">Data de Encontro</label>
                <input type="date" class="form-control" id="validationCustom05" name="data_encontrado" required>
            </div>

            <div class="col-md-6 mb-3">
                <label for="validationTextarea" class="form-label">Imagem</label>
                <input type="file" class="form-control" aria-label="file example" name="arquivo" required>
            </div>
